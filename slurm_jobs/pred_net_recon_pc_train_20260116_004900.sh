#!/bin/bash
#SBATCH --job-name=pred_net_recon_pc_train_20260116_004900
#SBATCH --output=slurm_jobs/pred_net_recon_pc_train_20260116_004900_%j.out
#SBATCH --error=slurm_jobs/pred_net_recon_pc_train_20260116_004900_%j.err
#SBATCH --ntasks=1
