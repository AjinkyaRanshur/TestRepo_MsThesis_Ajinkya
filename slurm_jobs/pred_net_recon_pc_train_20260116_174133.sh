#!/bin/bash
#SBATCH --job-name=pred_net_recon_pc_train_20260116_174133
#SBATCH --output=slurm_jobs/pred_net_recon_pc_train_20260116_174133_%j.out
#SBATCH --error=slurm_jobs/pred_net_recon_pc_train_20260116_174133_%j.err
#SBATCH --ntasks=1
...
echo "Running 9 experiments (2 at a time)"
