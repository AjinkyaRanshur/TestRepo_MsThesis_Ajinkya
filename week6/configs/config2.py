...
model_name = "reconstruction_pc_class_train_higher_backward"
noise_type="s&p"
noise_param=0.0
experiment_name = "Classification Training Over 10 Timesteps with Higher Backward Hyperparameters On Pretrained Models"
