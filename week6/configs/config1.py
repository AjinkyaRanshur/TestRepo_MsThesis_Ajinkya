...
model_name = "reconstruction_pc_class_train_higher_forward"
noise_type="s&p"
noise_param=0.0
experiment_name = "Classification Training Over 10 Timesteps with Higher Forward Hyperparameters On Pretrained Models"
