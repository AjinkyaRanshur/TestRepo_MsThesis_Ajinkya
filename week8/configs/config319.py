...
gammaset = [[0.63, 0.63, 0.63, 0.63]]
betaset = [[0.63, 0.63, 0.63, 0.63]]
alphaset = [[0.05, 0.05, 0.05, 0.05]]

model_name = "pc_class_train_balanced"
noise_type = "s&p"
noise_param = 0.00
experiment_name = "Testing Model on Beta 0.63 and Gamma 0.63 and Alpha 0.05"
