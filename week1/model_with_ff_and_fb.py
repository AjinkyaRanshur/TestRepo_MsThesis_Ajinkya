...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        #self.fc3_fb(10,84)
        #self.fc2_fb(84,120)
        #self.fc1_fb(120,16*5*5)
        #self.conv2_fb(16,6,5)
        #self.pool_fb(2,2)
        #self.conv1_fb(6,3,5)

    def forward(self,x,network_setting):

        if network_setting=="forward":
...
#Training Module in forward Direction
