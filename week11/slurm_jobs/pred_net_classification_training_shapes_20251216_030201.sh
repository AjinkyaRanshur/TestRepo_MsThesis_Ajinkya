#!/bin/bash
#SBATCH --job-name=pred_net_classification_training_shapes_20251216_030201
#SBATCH --output=slurm_jobs/pred_net_classification_training_shapes_20251216_030201_%j.out
#SBATCH --error=slurm_jobs/pred_net_classification_training_shapes_20251216_030201_%j.err
#SBATCH --ntasks=1
