#!/bin/bash
#SBATCH --job-name=pred_net_recon_pc_train_20260110_065342
#SBATCH --output=slurm_jobs/pred_net_recon_pc_train_20260110_065342_%j.out
#SBATCH --error=slurm_jobs/pred_net_recon_pc_train_20260110_065342_%j.err
#SBATCH --ntasks=1
