#!/bin/bash
#SBATCH --job-name=pred_net_classification_training_shapes_20251216_163339
#SBATCH --output=slurm_jobs/pred_net_classification_training_shapes_20251216_163339_%j.out
#SBATCH --error=slurm_jobs/pred_net_classification_training_shapes_20251216_163339_%j.err
#SBATCH --ntasks=1
