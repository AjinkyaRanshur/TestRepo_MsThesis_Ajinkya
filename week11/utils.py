...
def generate_model_name(pattern,seed,train_cond,recon_timesteps,classification_timesteps=10,dataset,base_model=None):
	if train_cond == "recon_pc_train":
		...
		model_name=f"pc_recon{recon_timesteps}_{dataset}_class{classification_timesteps}_{pattern}_seed{seed}"
		return model_name
